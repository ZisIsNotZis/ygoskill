---
name: ygopro-implementation
description: YGOPro implementation knowledge including database, YDK, scripts, and tools
---
# YGOPro Implementation Knowledge

- **[database.md](database.md)** — Card database schema and queries
