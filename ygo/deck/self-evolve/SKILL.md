...
- Step 1: Build a deck strictly following [build/SKILL.md](../build/SKILL.md) 5-step workflow
- Step 2: Run ydkcheck.py with section all — this is a dedicated non-skippable verification step, every error must be resolved
- Step 3: Compare with reference decks following [compare/SKILL.md](../compare/SKILL.md) — write down ALL differences unconditionally
...
- Step 5: Update the root-cause skill file — [build/SKILL.md](../build/SKILL.md), [metrics.md](../metrics.md), [engines.md](../engines.md), [combat.md](../combat.md), [compare/SKILL.md](../compare/SKILL.md), or catalog files
...
- ydkcheck.py returns errors after strictly following build/SKILL.md — build skill gap
- ydkcheck.py quality score below 60 after following build/SKILL.md — metrics or build skill gap
...
- If build workflow step is ambiguous or missing: add clarification or new step to [build/SKILL.md](../build/SKILL.md)
...
- If comparison workflow has gap: update [compare/SKILL.md](../compare/SKILL.md)
- If combat strategy is wrong: update [combat.md](../combat.md) with corrected strategy and evidence

- **Verification**

- After updating skill files, verify they are under 200 lines per [self-evolve/markdown-maintenance.md](../../../self-evolve/markdown-maintenance.md)
